...
public class PhotographEffectRegistry {
    ...
    static {
        ...
        add("cataclysm:ender_guardian",
                "§a挥击/远程命中时 15% 概率在视线前方地面升起 虚空符文",
                "§a虚空符文：1.5 秒后引爆；对范围内目标造成 等同攻击面板 的魔法伤害",
                "§a佩戴时受到的所有来源伤害 -15%");
        add("cataclysm:ignis",
                "§a挥击/远程命中时 15% 概率连发 3 颗 烈焰轰击（不破坏方块）",
        ...
        add("legendary_monsters:posessed_paladin",
                "§a挥击/远程命中时 15% 概率在目标脚下逐排升起 3 根灵魂尖刺",
                "§a灵魂尖刺：命中造成 等同攻击面板 的幽灵伤害",
                "§a佩戴时赋予 抗性提升1 效果",
                "§c佩戴时近战伤害 -12%");
        add("legendary_monsters:cloud_golem",
                "§a挥击/远程命中时 10% 概率从胸口射出 天穹激光",
        ...
        add("minecraft:skeleton", "§a远程攻击 +10%", "§a挥击/远程命中时 15% 概率朝视线方向射出 3 支弓箭", "§a弓箭：每支造成 等同攻击面板 的伤害");
